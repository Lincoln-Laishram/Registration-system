...
import { HandleRegister, HandleDelete, HandleUpdate } from "@/func/Functionality";
...
export const Register = () => {
    ...
    const [editData, setEditData] = useState({ patientFirstName: "", patientLastName: "", disease: "", phoneNumber: "" });
